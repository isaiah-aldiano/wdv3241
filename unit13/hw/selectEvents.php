...
<form action="selectEvents.php" method="post" id="eventForm">
    ...
    <div id="eventItem">
        ...
        <input type="text" name="presenter" id="presenter" required>
    </div>

    <div id="eventItem">
        <label for="description">Description</label> <br>
        <textarea name="description" id="" cols="35" rows="5" required></textarea>
    </div>
...
<a href="13_3_logout.php"><button>Log Out</button></a>
</body>
</html>
